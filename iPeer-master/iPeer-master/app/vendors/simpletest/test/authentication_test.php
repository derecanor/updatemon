...
class TestOfRealm extends UnitTestCase {
    ...
    function testNewUrlInSameDirectoryDoesNotChangeRealm() {
        ...
        $this->assertTrue($realm->isWithin(
                new SimpleUrl('http://www.here.com/path/login.html')));
        $this->assertFalse($realm->isWithin(
                new SimpleUrl('http://www.here.com/login.html')));
    }
    ...
    function testNewUrlMakesRealmTheCommonPath() {
        ...
        $this->assertTrue($realm->isWithin(
                new SimpleUrl('http://www.here.com/path/here/login.html')));
        $this->assertTrue($realm->isWithin(
                new SimpleUrl('http://www.here.com/path/there/login.html')));
        $this->assertTrue($realm->isWithin(
                new SimpleUrl('http://www.here.com/path/login.html')));
        $this->assertFalse($realm->isWithin(
                new SimpleUrl('http://www.here.com/login.html')));
        $this->assertFalse($realm->isWithin(
                new SimpleUrl('http://www.here.com/paths/login.html')));
        $this->assertFalse($realm->isWithin(
